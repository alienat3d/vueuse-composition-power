...
import { summaryAccessibilityLabelKey } from '@/injectKeys'

const summaryAccessibilityLabel: string | undefined = inject(summaryAccessibilityLabelKey)
...
<template>
  <details>
    <summary :aria-label="summaryAccessibilityLabel" :title="summaryAccessibilityLabel">
  ...
  <dialog ref="nativeDialogEl" class="modal-overlay">
    <section class="modal-content">
      <form method="dialog">
        <button class="close" aria-label="Click or Hit ESC" title="Click or Hit ESC">Close</button>
      </form>
      <article>
